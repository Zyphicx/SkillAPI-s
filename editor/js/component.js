...
function TargetArea()
{
    ...
    this.data.push(new ListValue("Include Caster", "caster", [ 'Always', 'Only In Area', 'Never' ], 'Only In Area')
        .setTooltip('If the caster should be included in the target list always / only when within the area / never')
    );
